...
const ChatPage = () => {
  ...
  const sendMessageHandler = async(receiverId) => {
    try {
      const res = await axios.post(`${process.env.NEXT_PUBLIC_API_BASE_URL}/message/send/${receiverId}` , {textMessage} , {
        headers : {
  ...
  return (
    <div className="flex ml-[16%] h-screen">
      <section className="w-full md:w-1/4 my-8">
        ...
        <div className="overflow-y-auto h-[80-vh]">
      ...
      </section>
      {
        ...
        (
            <div className="flex flex-col items-center justify-center mx-auto">
                ...
                <h1 className="font-md text-xl">Your Messages</h1>
                <span>Send A Message to Start A test</span>
            </div>
        )
      }
    </div>
